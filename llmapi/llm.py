...
@click.option('--model', type=click.Choice(['big', 'medium', 'small']), help='Model size')
...
def main(provider, model, instructions, stop, temperature, max_tokens, messages):
    ...
    client = init_client(provider=provider, model=model, instructions=instructions, stop=stop, temperature=temperature)
